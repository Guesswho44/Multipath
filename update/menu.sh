...
Isadmin=$(curl -sS https://raw.githubusercontent.com/Guesswho44/Multipath/main/access | grep $MYIP | awk '{print $5}')
...
Exp=$(curl -sS https://raw.githubusercontent.com/Guesswho44/Multipath/main/access | grep $MYIP | awk '{print $3}')
fi
export RED='\033[0;31m'
...
rm /opt/.ver
version_up=$( curl -sS https://raw.githubusercontent.com/Guesswho44/Multipath/main/version)
